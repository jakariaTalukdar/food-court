              ...
              <div href="/" className="w-full md:w-auto flex items-center justify-between md:justify-start">
                ...
                <div className='flex items-center gap-x-2'>
                  <Link href="/login" className="md:hidden flex items-center gap-x-1 font-bold py-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-user-round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg>
                    <span>Login</span>
                  </Link>
